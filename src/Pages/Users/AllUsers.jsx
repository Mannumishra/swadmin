...
const AllUsers = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://swhealthcare.digiindiasolutions.com/api/all-users", {
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await axios.delete(`https://swhealthcare.digiindiasolutions.com/api/delete-user/${id}`, {
