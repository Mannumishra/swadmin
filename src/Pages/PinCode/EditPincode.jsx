...
const EditPincode = () => {
    ...
    useEffect(() => {
        ...
        const fetchPincodeDetails = async () => {
            try {
                const response = await axios.get(`https://swhealthcare.digiindiasolutions.com/api/single-pincode/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://swhealthcare.digiindiasolutions.com/api/update-pincode/${id}`, pincodeData);
