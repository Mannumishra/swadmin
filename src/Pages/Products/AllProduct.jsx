...
const AllProduct = () => {
    ...
    const handleDelete = async (productId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`https://swhealthcare.digiindiasolutions.com/api/delete-product/${productId}`);
    ...
    const handleStatusChange = async (productId, field, currentValue) => {
        try {
            const response = await axios.put(`https://swhealthcare.digiindiasolutions.com/api/update-product/${productId}`, {
