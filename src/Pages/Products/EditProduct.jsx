...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://swhealthcare.digiindiasolutions.com/api/single-product/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataToSubmit.append('productDiscountPercentage', formData.productDiscountPercentage);
            ...
            const response = await axios.put(`https://swhealthcare.digiindiasolutions.com/api/update-product/${id}`, formDataToSubmit, { headers: { 'Content-Type': 'multipart/form-data' } });
        ...
        <>
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-2 me-2">
                        <label className="form-label">Discount %<sup className='text-danger'>*</sup></label>
                        <input
                            type="number"
                            className="form-control"
                    ...
                    <div className="col-md-2 me-2">
                        <label className="form-label">Final Price<sup className='text-danger'>*</sup></label>
                        <input
                            type="number"
                            className="form-control"
                    ...
                    <div className="col-md-2 me-2">
                        <label className="form-label">Tax %<sup className='text-danger'>*</sup></label>
                        <select name="tax" id="" onChange={handleInputChange} className='form-select'>
                    ...
                    <div className="col-md-2 me-2">
                        <label className="form-label">Stock<sup className='text-danger'>*</sup></label>
                        <select
                            className="form-select"
                            name="stock"
                    ...
                    <div className="col-md-6">
                        ...
                        />
                        &nbsp; <label className="form-label">Product Status (Available/Unavailable)<sup className='text-danger'>*</sup></label>
                    </div>
                    <div className="col-md-6">
                        <input
                            type="checkbox"
                            ...
                            onChange={handleCheckboxChange}
                        />
                        &nbsp; <label className="form-label">Product Best Seller (Available/Unavailable)<sup className='text-danger'>*</sup></label>
                    </div>
