...
const EditBanner = () => {
    ...
    useEffect(() => {
        const fetchBannerData = async () => {
            try {
                const response = await axios.get(`https://swhealthcare.digiindiasolutions.com/api/single-banner/${id}`);
                setBannerData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://swhealthcare.digiindiasolutions.com/api/update-banner/${id}`, formData, {
                headers: {
