...
const AllContactInquery = () => {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                const response = await axios.get('https://swhealthcare.digiindiasolutions.com/api/all-contacts');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://swhealthcare.digiindiasolutions.com/api/delete-contact/${id}`);
