...
const EditSubCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchSubCategory = async () => {
            try {
                const response = await axios.get(`https://swhealthcare.digiindiasolutions.com/api/single-subcategory/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://swhealthcare.digiindiasolutions.com/api/update-subcategory/${id}`,
                apiFormData,
                {
                    headers: {
