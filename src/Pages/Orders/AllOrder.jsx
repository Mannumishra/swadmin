...
const AllOrder = () => {
    ...
    const fetchOrders = async () => {
        try {
            const response = await axios.get('https://swhealthcare.digiindiasolutions.com/api/order-data');
    ...
    const handleDelete = async (orderId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`https://swhealthcare.digiindiasolutions.com/api/delete-order-data/${orderId}`);
                if (response.status === 200) {
