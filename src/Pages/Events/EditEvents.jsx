...
const EditEvents = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/all-events'); // Redirect to the all events page
        } catch (error) {
                ...
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-6">
                        <label htmlFor="eventHeading" className="form-label">
                            Event Heading<sup className='text-danger'>*</sup>
                        </label>
                        <input
                            type="text"
                            className="form-control"
                    ...
                    <div className="col-md-12">
                        <label htmlFor="eventDetails" className="form-label">
                            Event Details<sup className='text-danger'>*</sup>
                        </label>
                        <JoditEditor
                            ref={editor}
                    ...
                    <div className="col-12 text-center">
                        <button
                            ...
                            disabled={btnLoading}
                        >
                            {btnLoading ? 'Please Wait...' : 'Update Event'}
                        </button>
                    </div>
                </form>
            </div>
