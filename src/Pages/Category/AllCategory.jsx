...
const AllCategory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://swhealthcare.digiindiasolutions.com/api/all-category'); // Replace with your API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`https://swhealthcare.digiindiasolutions.com/api/delete-category/${id}`); // Replace with your API endpoint
