...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://swhealthcare.digiindiasolutions.com/api/signle-category/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://swhealthcare.digiindiasolutions.com/api/update-category/${id}`, formData, {
                headers: {
